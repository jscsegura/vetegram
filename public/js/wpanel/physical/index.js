(function() {
    const cfg = window.WPANEL_PHYSICAL_INDEX_CONFIG || {};
    ...
    window.vetegramWpanel.initDataTable({
        ...
        columns: [
            ...
            },
            {
                data: 'id',
                render: function(data, type, row) {
                    return '<a href="' + cfg.optionsBaseUrl + '/' + row.id + '"><img src="' + cfg.assets.menu + '"></a>';
                },
                orderable: false,
                searchable: false,
                className: 'text-center'
            },
            {
                data: 'id',
                render: function(data, type, row) {
                    return '<a href="' + cfg.editBaseUrl + '/' + row.id + '/edit"><img src="' + cfg.assets.edit + '"></a>';
                },
                orderable: false,
                searchable: false,
                className: 'text-center'
