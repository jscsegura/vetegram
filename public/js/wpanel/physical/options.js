(function() {
    const cfg = window.WPANEL_PHYSICAL_OPTIONS_CONFIG || {};
    ...
    window.vetegramWpanel.initDataTable({
        ...
        columns: [
            ...
            },
            {
                data: 'id',
                render: function(data, type, row) {
                    return '<a href="' + cfg.suboptionsBaseUrl + '/' + row.id + '"><img src="' + cfg.assets.menu + '"></a>';
                },
                orderable: false,
                searchable: false,
                className: 'text-center'
            },
            {
                data: 'id',
                render: function(data, type, row) {
                    return '<a href="' + cfg.editBaseUrl + '/' + row.id + '/edit-options"><img src="' + cfg.assets.edit + '"></a>';
                },
                orderable: false,
                searchable: false,
                className: 'text-center'
