(function() {
    const cfg = window.WPANEL_BREED_INDEX_CONFIG || {};
        ...
        columns: [
            ...
            { data: 'title_es' },
            {
                ...
                render: function(data, type, row) {
                    return '<a href="' + cfg.imagesBaseUrl + '/' + row.id + '"><img src="' + cfg.assets.menu + '"></a>';
                },
                orderable: false,
                searchable: false,
            ...
            },
            {
                data: 'id',
                render: function(data, type, row) {
                    return '<a href="' + cfg.editBaseUrl + '/' + row.id + '"><img src="' + cfg.assets.edit + '"></a>';
                },
                orderable: false,
                searchable: false,
                className: 'text-center'
