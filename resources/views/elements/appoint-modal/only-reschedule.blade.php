<div class="modal fade" id="onlyRescheduleModal" tabindex="-1" aria-labelledby="cancelModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          ...
          <div id="dateModalCancel" style="display: none;">
            <div class="d-flex flex-row gap-3 mb-4">
              ...
              <div>
                  ...
                  <select id="hourModalCancelRe" name="hourModalCancelRe" class="form-select fc requerido" onchange="reserverHourAppointmentToReschedule(this);">
        ...
        <div class="modal-footer px-3 px-md-4 pb-3 pb-md-4 pt-0">
          <button type="button" onclick="confirmSaveActionReschedule();" class="btn btn-primary btn-sm px-4">{{ trans('dash.text.btn.save') }}</button>
        </div>
      </div>
    </div>
</div>
...
<script>
    ...
    function setIdAppointmentToOnlyReschedule(id, user_id, onlyReagend = 0) {
    ...
    function reserverHourAppointmentToReschedule(obj) {
        var id = $(obj).val();
        if(id != '') {
            $.ajaxSetup({
                headers: {
