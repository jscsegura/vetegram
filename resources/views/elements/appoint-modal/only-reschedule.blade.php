    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          ...
          <div id="dateModalCancel" style="display: none;">
            <div class="d-flex flex-row gap-3 mb-4">
              ...
              <div>
                  ...
                  <select id="hourModalCancelRe" name="hourModalCancelRe" class="form-select fc requerido" data-appoint-action="only-reschedule-hour">
        ...
        <div class="modal-footer px-3 px-md-4 pb-3 pb-md-4 pt-0">
          <button type="button" class="btn btn-primary btn-sm px-4" data-appoint-action="only-reschedule-save">{{ trans('dash.text.btn.save') }}</button>
        </div>
      </div>
    </div>
</div>
...
<script>
  ...
  window.APPOINT_MODAL_CONFIG.onlyReschedule = {
    ids: {
      modal: 'onlyRescheduleModal',
