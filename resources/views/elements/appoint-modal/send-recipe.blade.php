    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="fw-normal mb-0 text-secondary">{{ trans('dash.label.send.recipe') }}</h6>
          <button type="button" class="btn-close small" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body p-3 p-md-4">
          <div>
            <input type="hidden" name="setIdAppointmentToSendRecipe" id="setIdAppointmentToSendRecipe" value="0">
            <input type="text" name="emailToSendRecipe" id="emailToSendRecipe" class="form-control fc" placeholder="{{ trans('dash.label.element.email') }}">
          </div>
        </div>
