                    ...
                    @if(count($invoices) > 0)
                        ...
                        <tr class="position-relative">
                            ...
                            <td class="px-2 px-lg-3 py-1 py-lg-3" data-label="# Doc.:">
                                <a href="{{ route('invoice.detail', ['id' => $invoice['CLAVE'], 'doctype' => 0]) }}" class="cellMax text-break link-secondary">{{ $invoice['CLAVE'] }}</a>
                            </td>
                            ...
                            <td class="px-2 px-lg-3 py-1 py-lg-3 h-0 text-center">
                                ...
                                <div class="dropdown d-inline-block">
                                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow rounded-3">
                                        ...
                                        <li><a class="dropdown-item small" href="{{ route('invoice.detail', ['id' => $invoice['CLAVE'], 'doctype' => 0, 'printer' => 'printer']) }}" target="_blank">{{ trans('dash.btn.label.printer') }}</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
