    ...
    <body class="error-body no-top lazy" data-original="{{ asset('img/wpanel/login_background.jpg') }}" style="background-image: url('{{ asset('img/wpanel/login_background.jpg') }}')">
        <div class="container">
            <div class="row login-container animated fadeInUp">
                <form id="frm_login" class="animated fadeIn" method="POST" action="{{ route('wp.login.submit') }}" data-action="wpanel.validate" data-action-event="submit" data-action-args="nomsg|$el">
                    @csrf
