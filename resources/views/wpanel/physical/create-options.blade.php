...
<div class="row">
    ...
    <div class="col-md-6 text-right">
        <a class="btn btn-warning" href="{{ route('wp.physical.options', $categoryId) }}"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;Regresar</a>
    </div>
</div>
...
<div id="container">
    ...
    <form name="frm" id="frm" role="form" method="post" enctype="multipart/form-data" action="{{ route('wp.physical.storeOptions') }}" data-action="wpanel.validate" data-action-event="submit" data-action-args="default|$el">
        @csrf
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <select name="type" id="type" class="form-control requerido">
                    ...
                    <option value="3">Seleccion unica</option>
                </select>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="button" name="btnCancel" id="btnCancel" class="btn btn-danger" value="CANCELAR" data-action="navigate" data-url="{{ route('wp.physical.options', $categoryId) }}">
            </div>
        </div>
    </form>
</div>
