...
<div id="container">
    ...
    <form method="post" name="frm" id="frm" role="form" enctype="multipart/form-data" action="{{ url('wpanel/physical/update-options/' . $option->id) }}" onsubmit="return validate();">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="button" name="btnCancel" id="btnCancel" class="btn btn-danger" value="CANCELAR" onclick="window.open('{{ route('wp.physical.options', $option->id_category) }}','_self');">
            </div>
        </div>
    </form>
</div>
