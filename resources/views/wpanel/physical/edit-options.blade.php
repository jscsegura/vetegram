...
<div class="row">
    ...
    <div class="col-md-6 text-right">
        <a class="btn btn-warning" href="{{ route('wp.physical.options', $option->id_category) }}"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;Regresar</a>
    </div>
</div>
...
<div id="container">
    ...
    <form method="post" name="frm" id="frm" role="form" enctype="multipart/form-data" action="{{ url('wpanel/physical/update-options/' . $option->id) }}" data-action="wpanel.validate" data-action-event="submit" data-action-args="default|$el">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="button" name="btnCancel" id="btnCancel" class="btn btn-danger" value="CANCELAR" data-action="navigate" data-url="{{ route('wp.physical.options', $option->id_category) }}">
            </div>
        </div>
    </form>
</div>
