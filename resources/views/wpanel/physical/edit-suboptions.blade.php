...
<div id="container">
    ...
    <form method="post" name="frm" id="frm" role="form" enctype="multipart/form-data" action="{{ url('wpanel/physical/update-suboptions/' . $option->id) }}" data-action="wpanel.validate" data-action-event="submit" data-action-args="default|$el">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="button" name="btnCancel" id="btnCancel" class="btn btn-danger" value="CANCELAR" data-action="navigate" data-url="{{ route('wp.physical.Suboptions', $option->id_option) }}">
            </div>
        </div>
    </form>
</div>
