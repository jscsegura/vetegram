...
@section('js')
    ...
    <script>
        window.WPANEL_SLIDER_INDEX_CONFIG = {
            listUrl: "{{ route('wp.slider.list') }}",
            enabledUrl: "{{ route('wp.slider.enabled') }}",
            deleteUrl: "{{ route('wp.slider.delete') }}",
            editBaseUrl: "{{ url('wpanel/slider') }}",
            assets: {
    ...
    <script src="{{ asset('js/wpanel/slider/index.js') }}"></script>
@stop
