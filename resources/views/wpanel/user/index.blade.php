...
@section('js')
    ...
    <script>
        window.WPANEL_USER_INDEX_CONFIG = {
            listUrl: "{{ route('wp.users.list') }}",
            enabledUrl: "{{ route('wp.users.enabled') }}",
            deleteUrl: "{{ route('wp.users.delete') }}",
            editBaseUrl: "{{ url('wpanel/users') }}",
            assets: {
    ...
    <script src="{{ asset('js/wpanel/user/index.js') }}"></script>
@stop
