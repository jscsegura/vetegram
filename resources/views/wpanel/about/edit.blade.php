...
<div class="row">
    <div class="col-md-6">
        <div class="page-title">
            <h3>Editar rubro sobre nosotros</h3>
        </div>
    </div>
...
<div id="container">
    ...
    <form method="post" name="frm" id="frm" role="form" enctype="multipart/form-data" action="{{ url('wpanel/about/' . $about->id) }}" data-action="wpanel.validate" data-action-event="submit" data-action-args="default|$el">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" name="description_es" id="description_es" class="form-control" value="{{ $about->description_es }}" maxlength="255">
            </div>
            <div class="col-md-6">
                <label>Descripción Inglés(*):</label>
                <input type="text" name="description_en" id="description_en" class="form-control" value="{{ $about->description_en }}" maxlength="255">
            </div>
        </div>
        <div class="row">
            <div class="col-md-12"><p>&nbsp;</p></div>
        ...
        <div class="row">
            <div class="col-md-6">
                <label>Icono:</label>
                <input type="text" name="icon" id="icon" class="form-control requerido" value="{{ $about->image }}" data-action="open-icons">
            </div>
        </div>
        <div class="row">
            <div class="col-md-12"><p>&nbsp;</p></div>
