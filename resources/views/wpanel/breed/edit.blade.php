...
<div class="row">
    <div class="col-md-6">
        <div class="page-title">
            <h3>Editar Raza de animal <span style="font-size: 0.6em">({{ $row->title_es }})</span></h3>
        </div>
    </div>
...
<div id="container">
    ...
    <form method="post" name="frm" id="frm" role="form" enctype="multipart/form-data" action="{{ url('wpanel/animal-breed/update/' . $breed->id) }}" data-action="wpanel.validate" data-action-event="submit" data-action-args="default|$el">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="button" name="btnCancel" id="btnCancel" class="btn btn-danger" value="CANCELAR" data-action="navigate" data-url="{{ route('wp.animal-breed.index', $breed->type) }}">
            </div>
        </div>
    </form>
</div>
