...
<div class="row">
    ...
    <div class="col-md-6 text-right">
        <a class="btn btn-primary" data-action="log-with-user"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;Acceder como usuario</a>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <input type="text" readonly class="form-control" value="{{ $user->code }}">
    </div>
</div>
...
@section('js')
    <script>
        window.WPANEL_VETERINARY_DETAIL_CONFIG = {
            loginUrl: "{{ route('wp.login.with.user', $user->id) }}",
            confirmTitle: "Acceder como usuario",
            confirmMessage: "Seguro que desea ingresar al panel de Vetegram como si fuera el usuario, cualquier accion se registrara como si fue hecha por el usuario"
        };
    </script>
    <script src="{{ asset('js/wpanel/veterinary/detail.js') }}"></script>
@stop
