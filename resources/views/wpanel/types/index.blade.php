...
@section('js')
    ...
    <script>
        window.WPANEL_TYPES_INDEX_CONFIG = {
            listUrl: "{{ route('wp.animal-types.list') }}",
            enabledUrl: "{{ route('wp.animal-types.enabled') }}",
            deleteUrl: "{{ route('wp.animal-types.delete') }}",
            breedBaseUrl: "{{ url('wpanel/animal-breed/show') }}",
            editBaseUrl: "{{ url('wpanel/animal-types') }}",
            assets: {
    ...
    <script src="{{ asset('js/wpanel/types/index.js') }}"></script>
@stop
