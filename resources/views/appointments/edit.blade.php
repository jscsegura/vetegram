        ...
        <form class="col-lg-10 col-xl-8 col-xxl-6 mx-auto mt-4 mt-lg-0 mb-lg-5">
            ...
            <div class="d-flex flex-md-row gap-2 gap-md-4 mb-4">
                ...
                <div class="flex-grow-1">
                    ...
                    <input type="text" id="ddate" size="14" class="form-control fc" value="{{ date('d/m/Y', strtotime($appointment->date)) }}" data-dd-opt-default-date="{{ date('d/m/Y', strtotime($appointment->date)) }}" data-action="Appointments.setIdAppointmentToCancel" data-action-event="click" data-action-args="{{ $appointment->id }}|{{ $appointment->id_user }}|1" readonly data-bs-toggle="modal" data-bs-target="#cancelModal">
                </div>
                <div>
                    <label for="dtime" class="form-label small">{{ trans('dash.label.hour') }}</label>
                    <select class="form-select fc" id="dtime" data-action="Appointments.setIdAppointmentToCancel" data-action-event="click" data-action-args="{{ $appointment->id }}|{{ $appointment->id_user }}|1" readonly data-bs-toggle="modal" data-bs-target="#cancelModal">
                        <option value=""></option>
            ...
            <div class="d-flex flex-md-row gap-2 gap-md-4 mb-4">
                ...
                <div class="flex-grow-1">
                    ...
                    <input type="text" id="reason" name="reason" class="form-control fc" value="{{ $appointment->reason }}" data-action="Appointments.updateRecipe" data-action-event="change">
                </div>
            </div>
            ...
            <div class="d-flex flex-md-row gap-2 gap-md-4 mb-4">
                ...
                <div class="flex-grow-1">
                    ...
                    <input type="text" id="symptoms" name="symptoms" class="form-control fc" maxlength="255" value="{{ $appointment->symptoms }}" autocomplete="off" data-action="Appointments.updateRecipe" data-action-event="change">
                </div>
            </div>
            ...
            <div class="d-flex flex-column flex-md-row gap-2 gap-md-4">
                ...
                <div class="d-flex flex-column flex-sm-row gap-3 w-100">
                    <button id="btn-not-save" data-action="Appointments.updateRecipe" data-action-event="click" type="button" class="btn btn-primary px-4" style="display: none;">{{ trans('dash.btn.update.changes') }}</button>
                    ...
                    <button data-action="Appointments.setToCancel" data-action-event="click" data-action-args="{{ $appointment->id }}|{{ $appointment->id_user }}" type="button" class="btn btn-outline-danger ms-sm-auto px-4">{{ trans('dash.btn.cancel.appointment') }}</button>
                    @endif
                </div>
            </div>
        </form>
...
<script>
    window.APPOINTMENTS_EDIT_CONFIG = {
...
<script src="{{ asset('js/appointments/edit/core.js') }}"></script>
<script src="{{ asset('js/appointments/edit/ui.js') }}"></script>
<script src="{{ asset('js/appointments/edit/attachments.js') }}"></script>
<script src="{{ asset('js/appointments/edit/vaccines.js') }}"></script>
<script src="{{ asset('js/appointments/edit/recipe.js') }}"></script>
@endpush
