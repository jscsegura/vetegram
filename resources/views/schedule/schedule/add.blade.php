...
<section class="container-fluid pb-0 pb-lg-4">
    ...
    <div class="row px-2 px-lg-3 mt-2 mt-lg-4">
        ...
        <form name="frmAddAppointment" id="frmAddAppointment" action="{{ route('schedule.storeSchedule') }}" method="post" onsubmit="return validateSchedule();" enctype="multipart/form-data" class="col-lg-10 col-xl-8 col-xxl-6 mx-auto mt-4 mt-lg-0 mb-lg-5">
            @csrf
