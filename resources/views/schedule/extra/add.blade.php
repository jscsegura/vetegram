...
<script>
    ...
    function changeOptionDescription() {
        ...
        switch (mode) {
            case 'single':
                instruction.textContent = "{{ trans('dash.schedule.extra.section3.instruction1') }}";
                datePicker.placeholder = "{{ trans('dash.schedule.extra.section3.placeholder1') }}";
                break;

            case 'range':
                instruction.textContent = "{{ trans('dash.schedule.extra.section3.instruction2') }}";
                datePicker.placeholder = "{{ trans('dash.schedule.extra.section3.placeholder2') }}";
                break;

            case 'multiple':
                instruction.textContent = "{{ trans('dash.schedule.extra.section3.instruction3') }}";
                datePicker.placeholder = "{{ trans('dash.schedule.extra.section3.placeholder3') }}";
                break;
