            ...
            <div class="row gx-xl-5">
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control fc requerido" id="mname" name="mname" value="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-4">
                        <label for="detalles" class="form-label small">{{ trans('dashadmin.label.detail') }}</label>
                        <input type="text" class="form-control fc requerido" id="detail" name="detail" value="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-4">
                        <label for="quantity" class="form-label small">{{ trans('dashadmin.label.quantity') }}</label>
                        <input type="text" class="form-control fc requerido" id="quantity" name="quantity" value="0">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-4">
                        <label for="mindicator" class="form-label small">{{ trans('dashadmin.label.inventory.indication') }}</label>
                        <input type="text" class="form-control fc requerido" id="mindicator" name="mindicator" value="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <select class="form-select fc requerido" name="type" id="type">
                            <option value="gravado">{{ trans('dashadmin.label.add.taxed') }}</option>
                            <option value="exento">{{ trans('dashadmin.label.add.exonerated') }}</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <div class="d-flex gap-3">
                            <input type="text" class="form-control fc requerido" id="cabys" name="cabys" value="">
                ...
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <select class="form-select fc select2 requerido" id="unit" name="unit">
